...
{
	LOOKAHEAD(2) Assign() | LOOKAHEAD(2) (ArrayElement() <PVIRG>) | (ScalarElement() <PVIRG>)
}
*/
  static final public 
void Declaration() throws ParseException {/*@bgen(jjtree) Global */
